...
export function Endowment() {
  ...
  return (
    <div>
      ...
      <p>
        You will now select your quality preferences (utility funciton) for
        toothpaste. Using your <b>10</b> endowment points.
      </p>

      <p>
        Select how to spend your endowment points here. <br />
        You currently have <b>{remainingEndowmentPoints}</b> endowment points
        left.
      </p>
      <br></br>
      <br></br>
      ...
      <p>
        <b> Your preference for durability for this product</b>
      </p>
